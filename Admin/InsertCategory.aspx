<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAD.master" AutoEventWireup="true" CodeFile="InsertCategory.aspx.cs" Inherits="Admin_InsertCategory" %>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-10">
                                        <div class="checkbox i-checks">
                                            <label>
                                                <asp:CheckBox Text="Active" ID="cbactive" runat="server" />
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    ...
                                    <asp:Button ID="btnsaveCate" Text="Save change" CssClass="btn btn-primary" runat="server" OnClick="btnsaveCate_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
