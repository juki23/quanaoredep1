...
public class BaoKimPayment
{
    ...
    //Mã merchant site
    private string merchant_id = "15781";	//Thay bằng mã merchant site bạn đã đăng ký trên BaoKim.vn

    //Mật khẩu bảo mật
    private string secure_pass = "3fcd6b4dd6dd807b";	//Thay bằng mật khẩu giao tiếp giữa website của bạn với BaoKim.vn
